...
/* Standard interface: PServer, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO PServer_ProxyInfo;


static const RPC_CLIENT_INTERFACE PServer___RpcClientInterface =
    {
...
RPC_IF_HANDLE PServer_v1_0_c_ifspec = (RPC_IF_HANDLE)& PServer___RpcClientInterface;

extern const MIDL_STUB_DESC PServer_StubDesc;

static RPC_BINDING_HANDLE PServer__MIDL_AutoBindHandle;
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&PServer_ProxyInfo,
                  0,
                  0,
                  IDL_handle);
...
static const MIDL_STUB_DESC PServer_StubDesc = 
    {
    (void *)& PServer___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &PServer__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& PServer_ProxyInfo,   /* proxy/server info */
    0
    };
...
static const MIDL_STUBLESS_PROXY_INFO PServer_ProxyInfo =
    {
    &PServer_StubDesc,
    plugin__MIDL_ProcFormatString.Format,
    PServer_FormatStringOffsetTable,
