...
/* Standard interface: CServer, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO CServer_ProxyInfo;


static const RPC_CLIENT_INTERFACE CServer___RpcClientInterface =
    {
...
RPC_IF_HANDLE CServer_v1_0_c_ifspec = (RPC_IF_HANDLE)& CServer___RpcClientInterface;

extern const MIDL_STUB_DESC CServer_StubDesc;

static RPC_BINDING_HANDLE CServer__MIDL_AutoBindHandle;
    ...
    /* [string][in] */ const unsigned char *szOutput)
{
    ...
    NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&CServer_ProxyInfo,
                  0,
                  0,
                  IDL_handle,
                  szOutput);
...
static const MIDL_STUB_DESC CServer_StubDesc = 
    {
    (void *)& CServer___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &CServer__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& CServer_ProxyInfo,   /* proxy/server info */
    0
    };
...
static const MIDL_STUBLESS_PROXY_INFO CServer_ProxyInfo =
    {
    &CServer_StubDesc,
    controller__MIDL_ProcFormatString.Format,
    CServer_FormatStringOffsetTable,
