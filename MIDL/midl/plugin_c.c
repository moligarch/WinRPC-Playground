...
/* Standard interface: Plugin, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO Plugin_ProxyInfo;


static const RPC_CLIENT_INTERFACE Plugin___RpcClientInterface =
    {
...
RPC_IF_HANDLE Plugin_v1_0_c_ifspec = (RPC_IF_HANDLE)& Plugin___RpcClientInterface;

extern const MIDL_STUB_DESC Plugin_StubDesc;

static RPC_BINDING_HANDLE Plugin__MIDL_AutoBindHandle;
    ...
    /* [out] */ boolean *state)
{
    ...
    NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&Plugin_ProxyInfo,
                  0,
                  0,
                  h,
                  state);
...
/* 86 */	NdrFcShort( 0x8 ),	/* 8 */
/* 88 */	NdrFcShort( 0x0 ),	/* 0 */
/* 90 */	0x43,		/* Oi2 Flags:  srv must size, clt must size, has ext, */
			0x2,		/* 2 */
/* 92 */	0xa,		/* 10 */
			0x1,		/* Ext Flags:  new corr desc, */
/* 94 */	NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUB_DESC Plugin_StubDesc = 
    {
    (void *)& Plugin___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &Plugin__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& Plugin_ProxyInfo,   /* proxy/server info */
    0
    };
...
static const MIDL_STUBLESS_PROXY_INFO Plugin_ProxyInfo =
    {
    &Plugin_StubDesc,
    plugin__MIDL_ProcFormatString.Format,
    Plugin_FormatStringOffsetTable,
