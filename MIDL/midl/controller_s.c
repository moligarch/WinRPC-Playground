...
extern const MIDL_SERVER_INFO Controller_ServerInfo;

extern const RPC_DISPATCH_TABLE Controller_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE Controller___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xE4A0BCF4,0x7F16,0x4EB7,{0x8B,0x8B,0x4F,0x5B,0x31,0xD2,0x75,0xF6}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&Controller_v1_0_DispatchTable,
    0,
    0,
    0,
    &Controller_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE Controller_v1_0_s_ifspec = (RPC_IF_HANDLE)& Controller___RpcServerInterface;
...
static const RPC_DISPATCH_FUNCTION Controller_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE Controller_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)Controller_table
    };
...
static const MIDL_STUB_DESC Controller_StubDesc = 
    {
    (void *)& Controller___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& Controller_ServerInfo,   /* proxy/server info */
    0
    };

static const RPC_DISPATCH_FUNCTION Controller_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    0
    };
static const RPC_DISPATCH_TABLE Controller_NDR64__v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)Controller_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO Controller_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&Controller_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE Controller_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)RpcControllerHealthCheck,
    (SERVER_ROUTINE)RpcRequestController
    };

static const MIDL_SERVER_INFO Controller_ServerInfo = 
    {
    &Controller_StubDesc,
    Controller_ServerRoutineTable,
    controller__MIDL_ProcFormatString.Format,
    (unsigned short *) Controller_FormatStringOffsetTable,
    0,
