...
/* Standard interface: Plugin, ver. 1.0,
   GUID={0x49C68149,0xD4D0,0x41CA,{0xA9,0x54,0x2F,0xA8,0xDE,0x14,0xED,0x31}} */


extern const MIDL_SERVER_INFO Plugin_ServerInfo;

extern const RPC_DISPATCH_TABLE Plugin_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE Plugin___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x49C68149,0xD4D0,0x41CA,{0xA9,0x54,0x2F,0xA8,0xDE,0x14,0xED,0x31}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&Plugin_v1_0_DispatchTable,
    0,
    0,
    0,
    &Plugin_ServerInfo,
...
RPC_IF_HANDLE Plugin_v1_0_s_ifspec = (RPC_IF_HANDLE)& Plugin___RpcServerInterface;

extern const MIDL_STUB_DESC Plugin_StubDesc;
...
/* 70 */	0x8,		/* FC_LONG */
	...
	/* Procedure RpcPluginHealthCheck */
...
static const unsigned short Plugin_FormatStringOffsetTable[] =
    {
    0,
    36,
    72,
...
static const RPC_DISPATCH_FUNCTION Plugin_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE Plugin_v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)Plugin_table
    };
...
/* RpcCommandPlugin */
    { 
    /* RpcCommandPlugin */      /* procedure RpcCommandPlugin */
        (NDR64_UINT32) 17170496 /* 0x1060040 */,    /* explicit handle */ /* IsIntrepreted, ServerMustSize, ClientMustSize, HasExtensions */
...
{ 
/* RpcPluginHealthCheck */
    { 
    /* RpcPluginHealthCheck */      /* procedure RpcPluginHealthCheck */
...
/* RpcShutdown */
    { 
    /* RpcShutdown */      /* procedure RpcShutdown */
        (NDR64_UINT32) 17301568 /* 0x1080040 */,    /* explicit handle */ /* IsIntrepreted, HasReturn, HasExtensions */
        (NDR64_UINT32) 16 /* 0x10 */ ,  /* Stack size */
        (NDR64_UINT32) 0 /* 0x0 */,
        (NDR64_UINT32) 8 /* 0x8 */,
...
static const FormatInfoRef Plugin_Ndr64ProcTable[] =
    {
    &__midl_frag4,
    &__midl_frag4,
    &__midl_frag6,
...
static const MIDL_STUB_DESC Plugin_StubDesc = 
    {
    (void *)& Plugin___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& Plugin_ServerInfo,   /* proxy/server info */
    0
    };

static const RPC_DISPATCH_FUNCTION Plugin_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    NdrServerCallAll,
...
static const RPC_DISPATCH_TABLE Plugin_NDR64__v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)Plugin_NDR64__table
    };

static const MIDL_SYNTAX_INFO Plugin_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&Plugin_v1_0_DispatchTable,
    plugin__MIDL_ProcFormatString.Format,
    Plugin_FormatStringOffsetTable,
    plugin__MIDL_TypeFormatString.Format,
    0,
    0,
    0
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&Plugin_NDR64__v1_0_DispatchTable,
    0 ,
    (unsigned short *) Plugin_Ndr64ProcTable,
    0,
    0,
    0,
    0
...
static const SERVER_ROUTINE Plugin_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)RpcStart,
    (SERVER_ROUTINE)RpcShutdown,
    (SERVER_ROUTINE)RpcPluginHealthCheck,
    (SERVER_ROUTINE)RpcCommandPlugin
    };

static const MIDL_SERVER_INFO Plugin_ServerInfo = 
    {
    &Plugin_StubDesc,
    Plugin_ServerRoutineTable,
    plugin__MIDL_ProcFormatString.Format,
    (unsigned short *) Plugin_FormatStringOffsetTable,
    0,
    (RPC_SYNTAX_IDENTIFIER*)&_NDR64_RpcTransferSyntax,
    2,
    (MIDL_SYNTAX_INFO*)Plugin_SyntaxInfo
    };
#if _MSC_VER >= 1200
#pragma warning(pop)
#endif
